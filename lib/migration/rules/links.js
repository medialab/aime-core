          ...
          _(rows)
            ...
            .forEach(function(link) {
              ...
              if (typeof link.from_start_fr === 'number' && sourceNodeFr && targetNodeFr)
                batch.relate(sourceNodeFr.id, 'REFERS_TO', targetNodeFr.id, {
                  start: link.from_start_fr,
                  stop: link.from_stop_fr
                });

              if (typeof link.from_start_en === 'number' && sourceNodeEn && targetNodeEn)
                batch.relate(sourceNodeEn.id, 'REFERS_TO', targetNodeEn.id, {
              ...
              if (frNode) {
                _(formats)
                  ...
                  .forEach(function(f) {
                    ...
                    frNode.markdown = frNode.text.substring(0, f.fr.start) +
              ...
              if (enNode) {
                _(formats)
                  ...
                  .forEach(function(f) {
                    ...
                    enNode.markdown = enNode.text.substring(0, f.en.start) +

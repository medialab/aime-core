...
module.exports = function(neo4j) {
  ...
  return function(next) {
    neo4j.db.query('MATCH (n) WHERE n:Document OR n:Vocabulary OR n:Media OR n:Chapter OR n:Subheading OR n:Reference RETURN n;', function(err, nodes) {
      ...
      ['document', 'vocabulary', 'reference', 'media', 'subheading', 'chapter'].forEach(createSlugs);

...
module.exports = function(neo4j) {
  ...
  return function(next) {
    neo4j.db.query('MATCH (n) WHERE n:Document OR n:Vocabulary OR n:Resource OR n:Subheading RETURN n;', function(err, nodes) {
      ...
      ['document', 'vocabulary', 'resource', 'subheading'].forEach(createSlugs);

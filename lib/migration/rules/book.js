      ...
      chapters.forEach(function(chapter, i) {
        ...
        if (chapter.content_fr &&
          ...
          fr = book.save({
            ...
            mysql_model: 1,
            mysql_id: chapter.id,
            display_number: (~chapter.content_fr.search(/(introduction|conclusion)/i)) ? '·' : (++displayNumber)
          });
        ...
        if (chapter.content_en && chapter.content_en !== 'englishContent') {
          en = book.save({
            ...
            mysql_model: 1,
            mysql_id: chapter.id,
            display_number: (~chapter.content_en.search(/(introduction|conclusion)/)) ? '·' : displayNumber
          });

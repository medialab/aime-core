...
module.exports = function(mysql, neo4j) {
  ...
  return function(topNext) {
    async.waterfall([
      ...
      {
        neo4j.db.query('MATCH (c:Document {source_platform:"crossings"})-[rt:RELATES_TO]-(mc:Crossing)-[d:DEFINES]-(v:Vocabulary)-[vp:HAS]-(p:Paragraph) WHERE c.lang=v.lang and vp.order=0 return c,rt,mc,d,v,p  LIMIT 20',next);
      },
